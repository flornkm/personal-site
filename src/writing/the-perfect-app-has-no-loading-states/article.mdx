...
There is this amazing article, ["The best loading states are no loading states"](https://jjenzz.com/best-loading-states-are-no-loading-states), which looks at loading states from a more technical angle. I'm convinced that more than one solution can be correct, but some approaches to loading states are definitely wrong.

In this article, I want to look at loading states from a design perspective, and from an "easy to change" perspective.
<br />
